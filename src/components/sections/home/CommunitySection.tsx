...
const pillars = [
  {
    ...
    bullets: [
      ...
      'اتاق‌های گفتگوی صمیمی و پرسش‌وپاسخ با کوچ‌ها',
    ],
  ...
  },
  {
    ...
    bullets: [
      ...
      'چک‌لیست‌ها و ورک‌شیت‌های تمرینی کوچ‌ها',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-12 md:mb-16">
          ...
          <p className="text-sm sm:text-base text-brand-neutral-600 leading-relaxed">
            رشد پایدار زمانی اتفاق می‌افتد که در کنار یادگیری و کوچینگ، در محیطی حمایتی از افراد هم‌فرکانس قرار بگیرید.
          </p>
        </div>
