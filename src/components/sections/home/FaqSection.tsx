...
export const faqs = [
  {
    ...
    answer:
      'جلسه معارفه یک گفتگوی اختصاصی ۳۰ دقیقه‌ای و کاملاً رایگان با کوچ منتخب شماست. در این جلسه، شما چالش و هدف اصلی‌تان را مطرح می‌کنید، با شیوه تعامل و سبک کاری کوچ آشنا می‌شوید و در نهایت ارزیابی می‌کنید که آیا احساس راحتی و شیمی مناسب برای همکاری بلندمدت وجود دارد یا خیر.',
  },
  {
  ...
  {
    question: 'کوچ‌های بلومیا چه مدارک و تاییدیه‌هایی دارند؟',
    answer:
  ...
  {
    question: 'اگر پس از جلسه اول متوجه شدم کوچ برای من مناسب نیست چه کنم؟',
    answer:
      'هدف جلسه معارفه رایگان دقیقاً همین است که بدون هیچ ریسک مالی، میزان انطباق خود با کوچ را بسنجید. اگر احساس کردید سبک آن کوچ با شما هماهنگ نیست، می‌توانید به راحتی با یکی دیگر از کوچ‌های تخصصی بلومیا جلسه معارفه داشته باشید.',
  },
  {
