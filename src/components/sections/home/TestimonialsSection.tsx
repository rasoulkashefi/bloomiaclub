...
const testimonials = [
  ...
  {
    text: 'بزرگترین چالش من عدم تمرکز و پراکندگی اهدافم بود. در بلومیا کوچی را پیدا کردم که دنیای من را می‌فهمید. با کمک او توانستم ساختار روزانه‌ام را بازسازی کنم و حالا با استرس کمتر، خروجی‌های بسیار باکیفیت‌تری در پروژه‌هایم دارم.',
